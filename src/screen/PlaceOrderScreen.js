...
<Helmet>   
<title>Order Preveiew</title>
</Helmet>
   

<h1 className='my-3'>Order Preveiew</h1>
<Row>
    <Col md={8} >
        <Card className='mb-3'>
        <Card.Body>
            <Card.Title>Shiping</Card.Title>
            <Card.Text>
         ...
         {cart.cartItems.map((item)=>(
            <ListGroup.Item key={item._id}>
                <Row className='align-items-center'>
                                     <Col md={6} >
                        <img src={item.images} alt={item.name} className='img-fluid rounded img-thumbnail' ></img>{''}
